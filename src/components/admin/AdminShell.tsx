...
type Section = "dashboard" | "contacts" | "careers" | "chats" | "database" | "ngo" | "notifications";
...
export default function AdminShell() {
  ...
  useEffect(() => {
    ...
    if (tab && ["dashboard", "contacts", "careers", "chats", "database", "ngo", "notifications"].includes(tab)) {
      setActiveState(tab);
    }
  }, []);
